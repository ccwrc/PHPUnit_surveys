...
class AnswerTest extends PHPUnit_Extensions_Database_TestCase {
    ...
    public function testSaveToDbAfterEditAnswer() {
        $answer = Answer::loadAnswerById(1);
        $answer->setAnswerText("text2");
        $this->assertTrue($answer->saveToDB());
    }

    public function testDeleteAnswerById() {
        $this->assertTrue(Answer::deleteAnswerById(22));
    }
